...
@Component({
  ...
  host: {
    ...
    '[style.position]': '"fixed"', // Fix the dialog to the viewport
    '[style.top]': '"50%"', // Center vertically
    '[style.left]': '"50%"', // Center horizontally
    '[style.transform]': '"translate(-50%, -50%)"', // Move it back by half of its width and height
    '[style.z-index]': '"1000"', // Ensure it is above other content
